...
<img src="../outputs/synthetic/figures/08_tradeoff_mse_vs_lambda.png" width="80%" />

*Рис. 8: Залежність MSE реконструкції від $\lambda$. Похибка незначно зростає, залишаючись у допустимих межах.*

<img src="../outputs/synthetic/figures/09_tradeoff_sym_vs_lambda.png" width="80%" />
...
<img src="../outputs/synthetic/figures/12_error_vs_angle.png" width="80%" />
...
<img src="../outputs/synthetic/figures/13a_robustness_pca.png" width="80%" />

*Рис. 16: PCA (Статика vs Обертання). $T_{new}$ показує ідеальне накладання, що свідчить про інваріантність.*

<img src="../outputs/synthetic/figures/13b_robustness_mds.png" width="80%" />

*Рис. 17: MDS (Статика vs Обертання). Хаотичність у $T_{old}$ проти впорядкованості у $T_{new}$.*

<img src="../outputs/synthetic/figures/13c_robustness_tsne.png" width="80%" />

*Рис. 18: t-SNE (Статика vs Обертання). Підтвердження кластерної стабільності.*

<img src="../outputs/synthetic/figures/13d_robustness_umap.png" width="80%" />
...
<img src="../outputs/mnist/figures/03_reconstructions_T_old.png" width="80%" />

*Рис. 20: Приклади реконструкції цифр методом $T_{old}$.*

<img src="../outputs/mnist/figures/04_reconstructions_T_new.png" width="80%" />

*Рис. 21: Приклади реконструкції цифр методом $T_{new}$. Візуально якість збережена на рівні з базовим методом.*

<img src="../outputs/mnist/figures/05_ssim_comparison.png" width="80%" />

*Рис. 22: Гістограма розподілу SSIM (Test set). Розподіли майже ідентичні.*

<img src="../outputs/mnist/figures/06_psnr_comparison.png" width="80%" />
...
<img src="../outputs/mnist/figures/07b_symmetry_bar_train.png" width="80%" />

*Рис. 24: Похибка симетрії (Train metrics). Значне зменшення комутаційної помилки для $T_{new}$.*

<img src="../outputs/mnist/figures/07b_symmetry_bar_test.png" width="80%" />
...
<img src="../outputs/mnist/figures/08_robustness_ssim_vs_angle_train.png" width="80%" />

*Рис. 26: SSIM vs Кут (Train). Нижній графік показує відношення $SSIM_{new} / SSIM_{old}$.*

<img src="../outputs/mnist/figures/08_robustness_ssim_vs_angle_test.png" width="80%" />

*Рис. 27: SSIM vs Кут (Test). Перевага $T_{new}$ помітна при певних кутах (Ratio > 1.0).*

<img src="../outputs/mnist/figures/09_robustness_psnr_vs_angle_train.png" width="80%" />

*Рис. 28: PSNR vs Кут (Train).*

<img src="../outputs/mnist/figures/09_robustness_psnr_vs_angle_test.png" width="80%" />
...
<img src="../outputs/mnist/figures/09a_scatter_pca_train.png" width="80%" />

*Рис. 30: PCA Проекція (Train).*

<img src="../outputs/mnist/figures/09a_scatter_pca_test.png" width="80%" />

*Рис. 31: PCA Проекція (Test). Порівняння просторів $B^*_{old}$ та $B^*_{new}$.*

<img src="../outputs/mnist/figures/09b_scatter_mds_train.png" width="80%" />

*Рис. 32: MDS Проекція (Train).*

<img src="../outputs/mnist/figures/09b_scatter_mds_test.png" width="80%" />

*Рис. 33: MDS Проекція (Test).*

<img src="../outputs/mnist/figures/09c_scatter_tsne_train.png" width="80%" />

*Рис. 34: t-SNE Проекція (Train).*

<img src="../outputs/mnist/figures/09c_scatter_tsne_test.png" width="80%" />

*Рис. 35: t-SNE Проекція (Test).*

<img src="../outputs/mnist/figures/09d_scatter_umap_train.png" width="80%" />

*Рис. 36: UMAP Проекція (Train).*

<img src="../outputs/mnist/figures/09d_scatter_umap_test.png" width="80%" />

*Рис. 37: UMAP Проекція (Test).*

### 2.5 Візуалізація "Хаосу" (Visual Reconstruction)

Детальний аналіз реконструкції при фіксованих кутах обертання. Рядок "Advantage" (зелений/червоний) показує різницю помилок: зелений колір означає перевагу $T_{new}$.

<img src="../outputs/mnist/figures/10a_chaos_figure_test.png" width="80%" />

*Рис. 38: Реконструкція при 0° (Статика). Обидва методи працюють майже ідентично.*

<img src="../outputs/mnist/figures/10b_chaos_figure_test.png" width="80%" />

*Рис. 39: Реконструкція при 45°. Помітна деградація якості, але $T_{new}$ намагається краще зберегти структуру.*

<img src="../outputs/mnist/figures/10c_chaos_figure_test.png" width="80%" />
...
<img src="../outputs/mnist/figures/11a_robustness_pca_train.png" width="80%" />

*Рис. 41: PCA розширена візуалізація (Train).*

<img src="../outputs/mnist/figures/11a_robustness_pca_test.png" width="80%" />

*Рис. 42: PCA розширена візуалізація (Test). Перевірка змішування класів при обертанні.*

<img src="../outputs/mnist/figures/11b_robustness_mds_train.png" width="80%" />

*Рис. 43: MDS розширена візуалізація (Train).*

<img src="../outputs/mnist/figures/11b_robustness_mds_test.png" width="80%" />

*Рис. 44: MDS розширена візуалізація (Test).*

<img src="../outputs/mnist/figures/11c_robustness_tsne_train.png" width="80%" />

*Рис. 45: t-SNE розширена візуалізація (Train).*

<img src="../outputs/mnist/figures/11c_robustness_tsne_test.png" width="80%" />

*Рис. 46: t-SNE розширена візуалізація (Test).*

<img src="../outputs/mnist/figures/11d_robustness_umap_train.png" width="80%" />

*Рис. 47: UMAP розширена візуалізація (Train).*

<img src="../outputs/mnist/figures/11d_robustness_umap_test.png" width="80%" />
